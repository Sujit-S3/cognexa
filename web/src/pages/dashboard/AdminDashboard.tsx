  ...
  return (
    <div className={styles.container}>
      ...
      <GlassCard elevation="raised" glow className={styles.banner}>
        <div>
          <Badge tone="brand" style={{ marginBottom: '10px' }}>
            🛡️ Platform Governance
          </Badge>
          <h1 className={styles.title}>System Admin Panel</h1>
          <p className={styles.subtitle}>
            Monitor platform health, manage role assignments (RBAC), and oversee curriculum governance across
            Cognexa.
          </p>
        </div>
                ...
                <tr key={u._id}>
                  <td>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <img
                        src={u.photo || 'https://www.w3schools.com/howto/img_avatar.png'}
                        alt={u.name}
                        style={{
                          width: '32px',
                          height: '32px',
                          borderRadius: '50%',
                          border: '1.5px solid var(--nx-brand-400)',
                        }}
                      />
                      <div>
                  ...
                  <td>
                    <select
                      ...
                      value={u.role}
                      onChange={(e) =>
                        handleRoleChange(u._id!, e.target.value as 'student' | 'instructor' | 'admin')
                      }
                    >
                      <option value="student" style={{ background: '#0f172a' }}>
                        🎓 Student
                      </option>
                      <option value="instructor" style={{ background: '#0f172a' }}>
                        👨‍🏫 Instructor
                      </option>
